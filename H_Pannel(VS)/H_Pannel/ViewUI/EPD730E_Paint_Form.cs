...
{
    public partial class EPD730E_Paint_Form : MyDialog
    {
        ...
        public EPD730E_Paint_Form(Storage _storage)
        {
            InitializeComponent();
            ...
            this.ShowDialogEvent += EPD730E_Paint_Form_ShowDialogEvent;
            this.LoadFinishedEvent += EPD730E_Paint_Form_LoadFinishedEvent;

            this.rJ_Button_確定.MouseDownEvent += RJ_Button_確定_MouseDownEvent;
            this.rJ_Button_取消.MouseDownEvent += RJ_Button_取消_MouseDownEvent;
        }

        private void EPD730E_Paint_Form_ShowDialogEvent()
        {

        }
        private void EPD730E_Paint_Form_LoadFinishedEvent(EventArgs e)
        {
            DrawToPictureBox(CurrentStorage);

            this.PanelSelectEvent += EPD730E_Paint_Form_PanelSelectEvent;
        ...
        private void EPD730E_Paint_Form_PanelSelectEvent(Device.ValueName valueName)
        {
