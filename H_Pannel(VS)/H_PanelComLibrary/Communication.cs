...
namespace H_Pannel_lib
{
    ...
    public class Communication
    {
        ...
        {
            Size string_size = MeasureText(Text, font);
        ...
        static public Bitmap Get_Storage_bmp(Storage storage, string[] valuenames, double canvasScale)
        {
            ...
            using (Graphics g = Graphics.FromImage(bitmap))
            {
                ...
                if (ip_array.Length == 4)
                {
                    ...
                    size_IP = MeasureText(ip, new Font("微軟正黑體", 8, FontStyle.Bold));
                ...
                using (Graphics g = Graphics.FromImage(bitmap))
                {
                    ...
                    if (storage.Validity_period_Visable)
                    {
                        for (int i = 0; i < storage.List_Validity_period.Count; i++)
                        {
                            ...
                            SizeF size_Validity_period = MeasureText(str, storage.Validity_period_font);
                    ...
                    SizeF size_Code_font = MeasureText(storage.Code, storage.Code_font);
                    ...
                    SizeF size_Package_font = MeasureText(storage.Package, storage.Package_font);
                    ...
                    if (storage.Inventory_Visable)
                    {
                        ...
                        SizeF size_Inventory = MeasureText($"[{storage.Inventory}]", storage.Inventory_font);
        ...
        static public byte[] Storage_GetBitmapBytes(Storage storage, double scale = 1)
        {
            using (Bitmap bmp = Storage_GetBitmap(storage, scale))
        ...
        static public Bitmap EPD420_GetBitmap(Drawer drawer)
        {
                    ...
                    if (Boxes[i][k].Slave == false)
                    {
                        ...
                        if (_box.Validity_period_Visable)
                        {
                            for (int m = 0; m < _box.List_Validity_period.Count; m++)
                            {
                                ...
                                SizeF size_Validity_period = MeasureText(str, _box.Validity_period_font);
                        ...
                        SizeF size_Code = MeasureText($"{_box.Code}[{_box.Inventory}]", _box.Code_font);
            ...
            {
                string ip = ip_array[2] + "." + ip_array[3];
                SizeF size_IP = MeasureText(ip, new Font("微軟正黑體", 10, FontStyle.Bold));
        ...
        static public Bitmap EPD730_GetBitmap(Drawer drawer)
        {
            ...
            {
                string ip = ip_array[2] + "." + ip_array[3];
                SizeF size_IP = MeasureText(ip, new Font("微軟正黑體", 8, FontStyle.Bold));
        ...
        private static readonly Color[] Palette_360E_6Colors = new Color[]
       {
        ...
        {
            SizeF size_font = MeasureText(str, font);
